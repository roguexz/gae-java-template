 ...
 * few workarounds when running in the Dev & Production mode. Additionally this extends the FileUploadFilter from
 * PrimeFaces and setups an InMemoryFileItemFactory
 */
